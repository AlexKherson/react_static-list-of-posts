...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://alexKherson.github.io/react_static-list-of-posts/) and add it to the PR description.
